...
const MODULOS = [
  ...
  { id: "tipos_treinamento", label: "Tipos de Treinamento", icone: "🏷️", grupo: "Cadastros" },
...
const CRUD_CONFIG = {
  ...
  tipos_treinamento: {
    ...
    descricao: "Cursos e treinamentos oferecidos.",
    buscaPlaceholder: "Buscar por nome",
    ordenarPor: "nome",
    campos: [
    ...
    cardTitulo: (i) => i.nome,
    cardLinhas: (i) => [i.categoria, i.carga_horaria && `Carga horária: ${i.carga_horaria}`].filter(Boolean),
  },
  usuarios_sistema: {
